...
import {
  ...
  deleteAcademicActivities,
  addAcademicActivities,
  editAcademicActivities,
} from "@/api/academicActivities";
...
export default {
  ...
  methods: {
    // 获取项目立项列表
    getResearList() {
      getAcademicActivities(this.queryList).then((res) => {
        this.tableData = res.data.acaSemList;
    ...
    addFormSub() {
      ...
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          addAcademicActivities(this.addForm).then((res) => {
            // console.log(res);
    ...
    // 编辑项目立项表单提交
    edtiFormSub() {
      editAcademicActivities(this.eidtForm).then((res) => {
        console.log(res)
    ...
    async delRowInfo(id) {
      ...
      if (confirmResult !== "confirm") {
        ...
        deleteAcademicActivities({ id: id }).then((res) => {
          console.log(res);
          this.$message.success(res.msg);
          this.getResearList();
        });
