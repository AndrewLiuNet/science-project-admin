  ...
  <div class="approve">
    ...
    <div class="tools">
      ...
      <el-dialog title="添加" :visible.sync="addDialogVisible" width="50%">
        ...
        >
          <el-form-item label="报告名称">
            <el-input v-model="addForm.report_name" />
          </el-form-item>
      ...
      <el-dialog title="修改" :visible.sync="editDialogVisible" width="50%">
        ...
        >
          <el-form-item label="报告名称">
            <el-input v-model="eidtForm.report_name" />
          </el-form-item>
          <el-form-item label="作者">
    ...
    <el-card class="data">
      <el-table :data="data" show-summary style="width: 100%">
        ...
        <el-table-column label="2020年授权专利" align="center">
        ...
        <el-table-column label="2020年申请专利" align="center">
...
<script>
import { getAwardWinningAchievementsList } from "@/api/publishedPapers";
...
export default {
  ...
  methods: {
    // 获取咨询报告列表
    getResearList() {
      getAwardWinningAchievementsList(this.queryList).then((res) => {
