    ...
    <div class="tools">
      ...
      <div class="tools-btn">
        ...
        <el-button   style="margin-left:10px;" type="primary" plain>  <a
          href="/static/科研项目.xlsx" download>下载模板</a></el-button>
          </div>
      <!-- 添加模态框 -->
  ...
  data() {
    return {
      ...
      queryList: {
        ...
        yearId: "",
        searchStr: "",
        projectTypeId: localStorage.getItem("projectTypeId3"),
      },
      yearOptions: [], // 年份下拉列表值
      ...
      addForm: {
        ...
        projectTypeId: localStorage.getItem("projectTypeId3"), //项目类别 projectTypeName
        isFinish: 0,
      },
      isFinishOptions: [
        {
    ...
    getProjectTypeList() {
      getProjectTypeList().then((res) => {
        for (let i = 0; i < res.data.length; i++) {
          if (res.data[i].typeName == "装备军内科研项目") {
            localStorage.setItem("projectTypeId3", res.data[i].projectTypeId);
          }
        }
      });
    },
