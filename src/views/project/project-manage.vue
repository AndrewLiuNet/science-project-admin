  ...
  <div class="approve">
    ...
    <div class="tools">
      ...
      <div class="tools-btn">
        ...
        添加项目名称：&nbsp;&nbsp;<el-button type="success" plain @click="addDialogVisible = true"
          >添 加</el-button
        >
      ...
      <el-dialog title="修改" :visible.sync="editDialogVisible" width="30%">
        ...
        >
          <el-form-item label="类型名称：" prop="typeName">
            <el-input v-model="eidtForm.typeName" />
          </el-form-item>
    ...
    <el-card class="data">
      <el-table :data="tableData" stripe >
        ...
        <el-table-column min-width="300px"  prop="typeName"  label="类型名称" align="center" />
        ...
        <el-table-column  min-width="300px"  label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-link
              ...
              icon="el-icon-delete"
              type="danger"
              @click="delRowInfo(scope.row.projectTypeId)"
              >删除</el-link
            >
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 获取项目结项列表
    getResearList() {
      getPageProjectType({page:this.currentPage,rows:this.pageSize}).then((res) => {
    ...
    async delRowInfo(id) {
      ...
      if (confirmResult !== "confirm") {
        ...
        delProjectType({ projectTypeId: id }).then((res) => {
          console.log(res);
          this.$message.success(res.msg);
          this.getResearList();
        });
